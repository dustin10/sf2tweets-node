...
var SF2TWEETS_USER = '<user>';
var SF2TWEETS_PASS = '<pass>';
...
TweetController.prototype._createAuthHeader = function _createAuthHeader() {
    return "Basic " + new Buffer(SF2TWEETS_USER + ":" + SF2TWEETS_PASS).toString('base64');
}
